...
public class ChannelInboundSameEventHandlerV1 extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        /**
         * 여러 이벤트 핸들러에서 같은 이벤트를 구현한 경우 먼저 등록된 이벤트 핸들러의 구현부에서 처리하면 이벤트가 사라진다. 만약 두번째
         * 핸들러에서도 같은 이벤트를 처리하고 싶으면 다음과 같이 메소드를 호출하면 채널파이프라인에서 이벤트가 사라지지 않고 발생하게된다. 다음은
         * 채널파이프라인에서 channelRead이벤트를 다음 핸들러도 처리할 수 있게끔 발생시키는 코드다
         */
